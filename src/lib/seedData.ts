...
export const SEED_POIS: Poi[] = [
  ...
  // Spots drone — uniquement HORS parcs nationaux (drone interdit dans le
  // Jotunheimen, la Hardangervidda et le Folgefonna). Rappels : enregistrement
  // sur flydrone.no, 150 m des personnes, vérifier les zones avant chaque vol.
  { id: pid(27), nom: '🛸 Gaustatoppen', categorie: 'drone', lat: 59.8542, lng: 8.6482, jour: '2026-07-16', etape_id: eid(3), ordre: 26, note: 'Crête et panorama sur 1/6 de la Norvège. Hors parc national. Décoller à l’écart de la foule du sommet (150 m), tôt le matin.', created_at: T0 },
  { id: pid(28), nom: '🛸 Gorge de Vøringsfossen', categorie: 'drone', lat: 60.4108, lng: 7.21, jour: '2026-07-17', etape_id: eid(4), ordre: 27, note: 'Le plan le plus spectaculaire du voyage : la chute de 182 m et le canyon de Måbødalen. Voler tôt (foule en journée) ; rafales dans la gorge.', created_at: T0 },
  { id: pid(29), nom: '🛸 Lofthus & Sørfjorden', categorie: 'drone', lat: 60.3333, lng: 6.65, jour: '2026-07-18', etape_id: eid(5), ordre: 28, note: 'Vergers suspendus entre fjord et glacier. Voler au-dessus de l’eau, à 150 m des maisons — ne pas approcher le plateau du Folgefonna (parc national).', created_at: T0 },
  { id: pid(30), nom: '🛸 Låtefossen', categorie: 'drone', lat: 59.9489, lng: 6.5858, jour: '2026-07-18', etape_id: eid(5), ordre: 29, note: 'La double cascade de 165 m sous le pont de la Rv13 — le classique absolu du drone en Norvège. Circulation + embruns : protéger la nacelle.', created_at: T0 },
  { id: pid(31), nom: '🛸 Tvindefossen', categorie: 'drone', lat: 60.6537, lng: 6.4923, jour: '2026-07-20', etape_id: eid(7), ordre: 30, note: 'Cascade « tressée » de 110 m au bord de l’E16 après Voss, grand parking au pied : le spot drone facile par excellence, sur la route de Gudvangen.', created_at: T0 },
  { id: pid(32), nom: '🛸 Aurlandsfjellet — Route des neiges', categorie: 'drone', lat: 60.966, lng: 7.241, jour: '2026-07-21', etape_id: eid(8), ordre: 31, note: 'Le ruban d’asphalte entre névés et lacs noirs à 1 100 m, désert au petit matin. Hors zones protégées — ne pas survoler le Nærøyfjord voisin (protégé).', created_at: T0 },
  { id: pid(33), nom: '🛸 Stegastein', categorie: 'drone', lat: 60.8667, lng: 7.15, jour: '2026-07-21', etape_id: eid(8), ordre: 32, note: 'Contre-plongée mythique sur l’Aurlandsfjord 650 m plus bas. Très fréquenté : créneau tôt le matin pour tenir les 150 m des personnes.', created_at: T0 },
  { id: pid(34), nom: '🛸 Col du Sognefjell', categorie: 'drone', lat: 61.5667, lng: 8.2667, jour: '2026-07-22', etape_id: eid(9), ordre: 33, note: 'Glaciers du Smørstabbreen, lacs turquoise et névés à 1 400 m. Le corridor de la Rv55 est hors du parc — ne pas franchir la limite du Jotunheimen (drone interdit).', created_at: T0 },
  { id: pid(35), nom: '🛸 Valdresflye — côté est', categorie: 'drone', lat: 61.362, lng: 8.806, jour: '2026-07-25', etape_id: eid(12), ordre: 34, note: '⚠️ Côté EST de la Rv51 uniquement : côté ouest (Jotunheimen — Gjende, Besseggen) le drone est interdit. Plateau minéral infini et rennes au petit matin.', created_at: T0 },
]
